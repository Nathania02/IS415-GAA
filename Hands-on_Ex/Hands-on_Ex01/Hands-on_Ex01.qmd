...
In this section, I will use st_read() (https://r-spatial.github.io/sf/reference/st_read.html) of sf package to import the following geospatial data into R:
...
# 4.0 Retrieval of Content in Data Frame
...
In geospatial data science, by looking at the feature information is not enough. We are also interested to visualise the geospatial features. I will plot() to plot a sf object as shown in the code chunk below.
...
In this section, I will project a simple feature data frame from one coordinate system to another coordinate system. The technical term of this process is called projection transformation.
...
In this section, I will learn perform two commonly used geoprocessing functions - buffering (https://www.gislounge.com/buffers-in-gis/) and point in polygon count.
...
Next, using ggplot2 method, I plot a scatterplot showing the relationship between Pre-school Density and Pre-school Count using the code chunk below:
